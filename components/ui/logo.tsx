...
export function Logo() {
  return (
    <Link href={'/'} title="Go home" className="sm:flex sm:items-center sm:space-y-0 sm:space-x-4 before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40">
      <Image
